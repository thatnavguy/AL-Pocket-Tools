...
| [Project Overview](docs/features/project-overview.md) | Scans all AL files and generates `ProjectOverview.md` (object counts, complexity summary, top 10 most complex) and `ALObjectList.md` (full object list with ID, caption, and complexity rating). |
