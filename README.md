...
| [Renumber Object IDs](docs/features/renumber-object-ids.md) | Finds AL objects sharing the same ID, uses git history to determine which is newest, and reassigns it a free ID from `app.json`'s `idRanges`. |
