...
import { pushPTEApps } from './commands/pushPTEApps';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand(
            'al-pocket-tools.convertAssignmentToValidate',
            () => { void convertAssignmentToValidate(); }
        ),
        vscode.commands.registerCommand(
            'al-pocket-tools.copyFileTo',
            (uri?: vscode.Uri, allUris?: vscode.Uri[]) => { copyFileTo(uri, allUris); }
        ),
        vscode.commands.registerCommand(
        ...
        vscode.commands.registerCommand(
            'al-pocket-tools.pushPTEApps',
            (uri?: vscode.Uri, allUris?: vscode.Uri[]) => { void pushPTEApps(context.secrets, output, uri, allUris); }
        ),
        rainbowIndent,
    );
